...
CREATE INDEX IF NOT EXISTS console_graph_node_locations_viewport_idx
    ON console_graph_node_locations(mode, min_x, min_y, max_x, max_y);

CREATE INDEX IF NOT EXISTS console_graph_node_locations_lane_idx
...
CREATE INDEX IF NOT EXISTS console_graph_edge_routes_viewport_idx
